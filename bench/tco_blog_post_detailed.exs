...
stats = %{time: 10, warmup: 10}
        |> Benchee.init
        |> Benchee.benchmark("map with TCO reverse",
                             fn -> MyMap.map_tco(list, map_fun) end)
        |> Benchee.benchmark("map simple without TCO",
                             fn -> MyMap.map_body(list, map_fun) end)
        |> Benchee.benchmark("map with TCO new arg order",
        ...
        |> Benchee.benchmark("map tail-recursive with ++",
